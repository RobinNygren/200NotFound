...
const Carousel: React.FC<CarouselProps> = ({ title, children }) => {
  ...
  return (
    <div className="relative mx-auto max-w-screen-xl bg-color-scheme-primary my-16">
      <h1 className="flex justify-center items-center text-2xl font-bold text-color-scheme-secondary">
        {title}
      </h1>
